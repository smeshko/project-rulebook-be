---
title: "API Contracts"
description: "REST API endpoint contracts and schemas for project-rulebook-be"
author: Claude
date: 2026-01-23
---
...
Rate limiting is applied via `RateLimitMiddleware` (production limits):
- Image Analysis: 3 requests/hour per IP
- Rules Generation: 10 requests/hour per IP
- API Operations: 50 requests/hour per IP
- General Requests: 500 requests/hour per IP
- Waitlist: 10 requests/hour per IP
