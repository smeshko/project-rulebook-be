...
- Generate a concise commit message in the format: `<agent_name>: <commit message>`
...
- Examples:
  - `sdlc_planner: add user authentication module`
  - `sdlc_implementor: fix login validation error`
  - `sdlc_planner: update dependencies to latest versions`
